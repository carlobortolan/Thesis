...
\begin{itemize}
    ...
    \item Optionally, a school can add additional \ac{VM}s for monitoring (Grafana, \href{https://github.com/prometheus/prometheus}{Prometheus}, \href{https://github.com/grafana/loki}{Loki}, etc.) or for deploying services such as the Voice Service for subtitling live streams and \ac{VOD}s using the Whisper LLM.
\end{itemize}
