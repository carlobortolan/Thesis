...
\begin{figure}[htpb]
    ...
    \caption[TUMLive Statistics]{TUMLive Viewing Statistics}\label{fig:tumlive-stats}
\end{figure}

\begin{figure}[htpb]
    \centering
    \includegraphics[width=\linewidth]{images/course_stream_user_activity_log_plot.png}
    \caption[Cumulative TUMLive Users, Courses and Streams over Time]{Cumulative TUMLive Users, Courses and Streams over Time}\label{fig:tumlive-stats-2}
\end{figure}
